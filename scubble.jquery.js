...
/*
Scroll bubble jQuery plugin
Based on http://cloudfront1.ia.net/wp-content/themes/iA4/js/bubble.js?ver=1.0
...
(function() {
  ...
  (function($, window, document) {
    var ScrollBubble, Time, _defaults;
    _defaults = {
      content: 'body',
      speed: 200,
      strings: {
    ...
    ScrollBubble = (function() {

      function ScrollBubble(el, options) {
        var _this = this;
      ...
      ScrollBubble.prototype.scroll = function() {
      ...
      ScrollBubble.prototype.timeToRead = function() {
      ...
      ScrollBubble.prototype.getText = function($el) {
        return $el.text();
      };

      ScrollBubble.prototype.offsets = function() {
    ...
    return $.fn.scrollBubble = function(options) {
      this.each(function() {
        var $el, bubble;
        $el = $(this);
        if (!$el.data('scrollBubble')) {
          bubble = new ScrollBubble(this, options);
          return $el.data('scrollBubble', bubble);
        }
      });
      return this;
    };
